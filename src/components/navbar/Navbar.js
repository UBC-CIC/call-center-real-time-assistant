            ...
            <Grid.Column>
                <Grid>
                    <Grid.Row className={"navbar-inner"} columns={2}>
                                ...
                                <Grid.Row>
                                    <Grid.Column width={7} textAlign={"center"} verticalAlign={"middle"}>
                                        <div className={"brand-wrapper"}>
                                            <span>E-Comm911 Real-Time Assistant</span>
                                        </div>
                                    </Grid.Column>
                        ...
                        <Grid.Column style={{paddingRight: "5px"}} width={1} verticalAlign={"middle"}
                                     textAlign={"right"} className={"navbar-column"}>
                            <AccountBoxIcon fontSize={"large"}/>
                        </Grid.Column>
                        <Grid.Column style={{paddingLeft: "0px"}} width={2} verticalAlign={"middle"} textAlign={"left"}
